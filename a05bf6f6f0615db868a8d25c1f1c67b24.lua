(function() 
    pcall(loadstring, game:HttpGet("https://cdn.shouko.dev/RokidManager/neyoshiiuem/main/anti-lgbt2.lua"))
    spawn(function() 
        task.wait(60)
        if not Loaded then game.Players.LocalPlayer:Kick() end
    end)
            ...
            if Child and typeof(Child) == "Instance" and Child:IsA("Tool") then
                ...
                elseif string.find(tostring(Child), "Fruit") then
                    task.spawn(function()
                        ...
                        if Config.AutoEatFruit and game:GetService("Players").LocalPlayer.Data.DevilFruit.Value == "" and table.find(Config.Items.FruitList, Child:GetAttribute("OriginalName")) then
                            while not LocalPlayer.Character:FindFirstChild(Child.Name) and task.wait() do 
